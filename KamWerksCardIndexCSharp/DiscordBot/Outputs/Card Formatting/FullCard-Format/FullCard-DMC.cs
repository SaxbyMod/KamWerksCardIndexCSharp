...
namespace KamWerksCardIndexCSharp.DiscordBot.Outputs.FullCard_Format
{
	public class FullCard_DMC
	{
		public async static Task<(DiscordMessageBuilder mess, string takeout)> DMC(int iterator30, string[] formattedcontent, string additionalproperties)
		{
			...
			var CardURL = $"https://raw.githubusercontent.com/SaxbyMod/NotionAssets/refs/heads/main/Formats/Desafts%20Mod%20(CTI)/{Capitalization.CapitalizeWithSpaces(dmcProperties[3].Replace("Beasts", "Beast").Replace("Magicks", "Magick").Replace("Technology", "Tech")).Replace(" ", "%20")}/{Capitalization.CapitalizeWithSpaces(dmcProperties[2]).Replace(" ", "%20")}.png";
